...
1. Inicie sesión en [Microsoft Flow](https://flow.microsoft.com) y seleccione **Mis flujos** en la barra de navegación superior.
    ...
    ![Opción Mis flujos](./media/run-tasks-on-a-schedule/create-flow.png)
2. Seleccione **Crear desde cero**.
   
    ![Crear un flujo desde cero](./media/run-tasks-on-a-schedule/create-from-blank.png)
3. En el cuadro **Buscar todos los conectores y desencadenadores** , escriba **Periodicidad** y, después, seleccione **Programación - Periodicidad**.
    ...
    ![Buscar el desencadenador de periodicidad](./media/run-tasks-on-a-schedule/select-recurrence.png)
4. En el cuadro de diálogo **Frecuencia**, especifique la frecuencia con que desea que se ejecute el flujo.
    ...
    ![Especificar periodicidad](./media/run-tasks-on-a-schedule/specify-recurrence.png)
...
5. Si especificó **Semana** en **Frecuencia**, especifique el día, o días, de la semana en que se debe ejecutar el flujo, así como la hora, u horas, del día en que debe ejecutarse.
    ...
    ![Especificación de opciones avanzadas](./media/run-tasks-on-a-schedule/advanced-options.png)
...
1. Inicie sesión en [Microsoft Flow](https://flow.microsoft.com) y seleccione **Mis flujos** en la barra de navegación superior.
    ...
    ![Crear un flujo desde cero](./media/run-tasks-on-a-schedule/create-flow.png)
2. Seleccione **Crear desde cero**.
...
4. Seleccione **Nuevo paso** y, luego, **Agregar una acción**.
    ...
    ![Opción para agregar una acción a un flujo](./media/run-tasks-on-a-schedule/add-action.png)
5. En la lista de acciones, realice cualquiera de estas acciones:
   ...
   * Seleccione **Retraso hasta** y, después, especifique una fecha con este formato.<br>AAAA-MM-DDTHH:MM:SSZ
     ...
     ![Agregar un retraso](./media/run-tasks-on-a-schedule/add-delay.png)
     ![Especificar un retraso en unidades de tiempo](./media/run-tasks-on-a-schedule/delay.png)
     ![Especificar retraso hasta](./media/run-tasks-on-a-schedule/delay-until.png)
