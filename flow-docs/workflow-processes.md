...
## <a name="where-do-you-customize-workflow-processes"></a>¿Dónde se personalizan los procesos de flujo de trabajo?  
 ...
 ![Procesos filtrados por flujo de trabajo en Dynamics 365](media/workflow-processes-filtered.PNG "Processes filtered by workflow in Dynamics 365")  
  
 En función de cómo se compile la aplicación, los usuarios pueden crear o modificar sus flujos de trabajo en ella. 
 
Los desarrolladores pueden crear flujos de trabajo con la información de la [Guía para desarrolladores de Dynamics 365 Customer Engagement](https://docs.microsoft.com/dynamics365/customer-engagement/developer/developer-guide) y las soluciones que compre pueden incluir flujos de trabajo que se pueden modificar.  
...
## <a name="workflow-properties"></a>Propiedades de flujo de trabajo  
 ...
 ![Creación de un flujo de trabajo en Dynamics 365](media/create-workflow.PNG "Creating a workflow in Dynamics 365")  
