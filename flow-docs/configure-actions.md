---
title: Configurar acciones para flujos de trabajo en PowerApps | MicrosoftDocs
ms.custom: ''
ms.date: 06/27/2018
ms.reviewer: ''
ms.service: flow
...
Puede habilitar una acción personalizada desde un flujo de trabajo sin escribir código. Más información: [invocación de acciones personalizadas desde un flujo de trabajo](invoke-custom-actions-workflow-dialog.md).  
 ...
 También puede crear una acción para que un desarrollador pueda usarla en el código o puede que tenga que editar una acción que se haya definido previamente. Al igual que los procesos de flujo de trabajo, tenga en cuenta lo siguiente:  
  
-   ¿Qué debe hacer la acción?  
  
-   ¿En qué condiciones debe realizarse la acción?  
...
Las acciones también tienen algo que los procesos de flujo de trabajo no son los argumentos de entrada y salida. Más información: [definir argumentos de proceso](configure-actions.md#BKMK_DefineProcessArgs)  
 ...
 **Definir argumentos de proceso**  
 En esta área, especificará los datos que la acción espera iniciar y los datos que se pasarán de la acción. Más información: [definir argumentos de proceso](configure-actions.md#BKMK_DefineProcessArgs)  
  
 **Agregar fases, condiciones y acciones**  
 Al igual que otros procesos, se especifican las acciones que deben realizarse y cuándo realizarlas. Más información: [Agregar fases, condiciones y acciones](configure-actions.md#BKMK_AddStagesConditionsAndActions)
...
## <a name="next-steps"></a>Pasos siguientes  
 [Operaciones](actions.md)  

 [Invocar acciones personalizadas desde un flujo de trabajo](invoke-custom-actions-workflow-dialog.md)   
 [Supervisión de acciones y flujos de trabajo en tiempo real](monitor-manage-processes.md#BKMK_MonitorSyncWorkflows)
